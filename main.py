...
def show_score(x, y, score_font, total_score_value):
    score = score_font.render("Score : " + str(total_score_value), True, (255, 255, 255))
    screen.blit(score, (x, y))


def reset_player_laser():
    globals()['laser_player_x'] = 0
    globals()['laser_player_y'] = INIT_PLAYER_Y
    globals()['laser_player_fire'] = False
